	...
	a.widget("bootstrap.bwizard", {
		...
		_createButtons: function() {
			...
			if(!this.buttons) {
				...
				if(c != "") {
					this.backBtn = a("<li class='previous' id='previous'><a href='#'>" + c + "</a></li>").appendTo(this.buttons).bind({
						click: function() {
							e.back();
							return false;
						}
		...
		_pageLize: function(f) {
			...
			if(f) {
				...
				this.container.addClass("basic-width basic-style clearfix");
